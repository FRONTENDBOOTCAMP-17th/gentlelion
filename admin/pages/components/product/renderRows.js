export function renderRows(tbody, products) {
  ...
  products.forEach((item) => {
    ...
    actionContainer.innerHTML = `
      <button id="editBtn" class="text-blue-600 hover:bg-blue-50 p-1 rounded transition-colors cursor-pointer">
        <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          <path d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
        </svg>
      </button>
      <button class="text-admin-red hover:bg-red-50 p-1 rounded transition-colors cursor-pointer">
        <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
