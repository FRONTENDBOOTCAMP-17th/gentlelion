...
export async function createMobileMenu() {
  ...
  const menuData = {
    mainNav: [
      { label: "선글라스", href: "/pages/sunglasses.html" },
    ...
    accountLinks: userName
      ? [{ label: `안녕하세요, ${userName}님`, href: "/components/profile/profile.html" }]
      : [{ label: "로그인 / 계정 생성", href: "/components/login/login.html" }],
    wishlist: {
      href: "/components/profile/profile.html",
      count: wishCount,
